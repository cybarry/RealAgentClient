...
function useThrottledCallback(callback, wait) {
  ...
  const timeout = (0, import_react61.useRef)(-1);
...
function useThrottledState(defaultValue, wait) {
  ...
  const timeoutRef = (0, import_react62.useRef)(null);
  const active = (0, import_react62.useRef)(true);
  const clearTimeout2 = () => window.clearTimeout(timeoutRef.current);
  const throttledSetValue = (0, import_react62.useCallback)(
    (newValue) => {
      if (active.current) {
        setValue(newValue);
        clearTimeout2();
...
function useThrottledValue(value, wait) {
  ...
  const active = (0, import_react63.useRef)(true);
  const timeoutRef = (0, import_react63.useRef)(-1);
  ...
  (0, import_react63.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
...
//# sourceMappingURL=chunk-UE4CVUFY.js.map
